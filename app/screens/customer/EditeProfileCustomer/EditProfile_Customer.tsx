...
const EditProfile_Customer = () => {
  ...
  const handleUbahPassword = () => {
    router.push({
      pathname: '/screens/customer/EditeProfileCustomer/UbahPassword_Customer',
      params: userParams
    });
  };
      ...
      <SafeAreaView style={styles.viewBg}>
        <View style={[styles.view, styles.viewBg]}>
          ...
          <View style={styles.item}>
            ...
            <TouchableOpacity 
              onPress={() => router.push({
                pathname: '/screens/customer/EditeProfileCustomer/UbahGambar_Customer',
                params: userParams
              })}
              activeOpacity={0.7}
          ...
          {/* Password Field */}
          <View style={styles.editProfileCustomerChild}>
...
export default EditProfile_Customer;
