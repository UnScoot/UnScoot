...
const RegisterDriver = () => {
	...
	const handleRegister = async () => {
		if (!nim || !email || !password || !nama || !jenisMotor || !plat) {
		...
		const result = await registerUserViaEdge({ nim, email, password, nama, jenisMotor, plat, role: "driver" });
		setLoading(false);
		if (!result.success) {
	...
	return (
		<SafeAreaView style={styles.container}>
			<View style={styles.view}>
				<Text style={styles.title}>Sebelum jadi Driver, isi ini dulu ya!</Text>
				...
				<View style={styles.inputContainer}>
					...
					<TextInput
						style={styles.input}
						placeholder="Masukkan Jenis Motor Kamu"
						placeholderTextColor="#c4bfbf"
						value={jenisMotor}
						onChangeText={setJenisMotor}
					/>
				</View>
				<View style={styles.inputContainer}>
					<TextInput
						style={styles.input}
						placeholder="Masukkin Nomor Plat Motor kamu ..."
						placeholderTextColor="#c4bfbf"
						value={plat}
			...
			>
				<View style={styles.modalOverlay}>
					<View style={styles.modalContent}>
						...
						<Text style={styles.modalTitle}>Pendaftaran Akun Driver kamu Berhasil!</Text>
						<TouchableOpacity
