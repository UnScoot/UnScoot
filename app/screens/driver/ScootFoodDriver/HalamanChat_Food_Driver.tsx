...
const HalamanChat_Food_Driver = () => {
  ...
  const { customerName, customerPhoto, restaurant, item } = useLocalSearchParams();
    		...
    		<SafeAreaView style={styles.halamanChat}>
                ...
                <View style={styles.chatContainer}>
                  ...
                  <View style={styles.messageBoxUser}>
                    <Text style={styles.messageTitle}>Hallo, tolong ambil pesanan saya :</Text>
                    <Text style={styles.messageDetails}>{`Restoran  : ${restaurant || "Warung Jepun"}
Pesanan  : ${item || "Ayam bakar 1x, Kentang goreng 2x"}`}</Text>
                    <Text style={styles.messageFooter}>Terimakasih, jangan lupa ya 😊</Text>
                    <Text style={styles.timeStamp}>09.00</Text>
                  </View>

                  {/* Message 2 - Driver Response */}
                  <View style={styles.messageBoxDriver}>
                    <Text style={styles.messageTextDriver}>Siap, otw ke restoran</Text>
                  ...
                  <View style={styles.messageBoxDriverLast}>
                    <Text style={styles.messageTextDriver}>Pesanan sudah diambil, otw ke lokasi Anda</Text>
