...
const HalamanChat_Ride_Driver = () => {
  const router = useRouter();
  const { customerName, customerPhoto, pickup, destination } = useLocalSearchParams();
    		...
    		<SafeAreaView style={styles.halamanChat}>
                ...
                <View style={styles.chatContainer}>
                  ...
                  <View style={styles.messageBoxUser}>
                    <Text style={styles.messageTitle}>Hallo, tolong jemput saya :</Text>
                    <Text style={styles.messageDetails}>{`Dari  : ${pickup || "Universitas Sebelas Maret"}
Ke     : ${destination || "Solo Grand Mall"}`}</Text>
                  ...
                  <View style={styles.messageBoxDriver}>
                    <Text style={styles.messageTextDriver}>Siap, otw ke lokasi Anda</Text>
                  ...
                  <View style={styles.messageBoxDriverLast}>
                    <Text style={styles.messageTextDriver}>Siap, saya sudah sampai di lokasi penjemputan</Text>
